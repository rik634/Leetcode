...
class Solution {
public:
    int segTree[400007];// we generally keep the size of segment tree to be 4 times the max size of baskets, to prevent the array overflow in segment tree implementation.
    vector<int> baskets;
